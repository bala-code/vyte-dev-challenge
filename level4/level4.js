class Calendar {
 ...
 slotsBetweenDates(start, end, duration)
 {
	 ...
	 {
		 if(obj.Appointments[i].start.getDate >startDate && obj.Appointments[i].End.getDate < endDate)
		 {
			 var diff = obj.Appointments[i].End-obj.Appointments[i].start;
